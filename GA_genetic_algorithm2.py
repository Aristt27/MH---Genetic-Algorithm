...
def crossover(ancestors, indices, fit_idx_vector, pop_inicial, alpha, cut_type = "ONE_CUT"):
...
def Genetic_Algorithm(Instancia, F_obj, params, stop_criteria,Presolve = True, Verbose = True):
  ...
  for generation in range(generations):
      ...
      recombinant_ancestors = crossover(ancestors, indices ,fit_idx_vector, pop_inicial, alpha, Cut_type)
